...
def lambda_handler():
    ...
    table_list = ["counterparty,currency","department","design","staff","sales_order","address","payment","purchase_order","payment_type","transaction"]
    for table in table_list:
        query_string = f"SELECT * FROM {table} WHERE " # <----finish this bit and store the last ingested time
        ...
        s3_client.put_object(
                    ...
                    Key=f'testdate/testtime/{table}',  # < ----- CHANGE THE FILE PATHS HERE
